...
# Poly1305
msg = Array{UInt8}("Cryptographic Forum Research Group");
...
msg2 = Array{UInt8}("This is a piece of message");
# end of test Poly1305
...
false && begin # Chacha20_Poly1305 # not passed yet
m = Array{UInt8}("This is a piece of message");
k = zeros(UInt8, 32);
n = zeros(UInt8, 8);
